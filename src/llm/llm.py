...
def choose_best_sentence(context, choices, port=8081):
    ...
    # prompt += "You are an ASR transcript selector.\n"
    # prompt += "Perform language model rescoring based on the top5 outputs generated by an Automatic Speech Recognition (ASR) system given a conversational history.\n"
    # prompt += "Analyze the provided context and ASR hypotheses to select the most accurate transcription.\n"
    # prompt += "Return the selection along with a brief reasoning in a structured JSON format.\n<|eot_id|>\n"
    ...
    #     "\nOutput the selected top-1 ASR transcription in JSON format.\n"
    #     "Strictly follow this schema:\n"
    #     "{\n"
    #     '  "selected_option": "1-5", # The number corresponding to the selected transcription\n'
    #     '  "transcription": "The selected top1 ASR transcription",\n'
    #     "}\n"
    #      <|eot_id|>\n"
    # )
