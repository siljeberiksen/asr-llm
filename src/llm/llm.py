...
def choose_best_sentence(context, choices, port=8081):
    ...
    prompt += "You are an ASR transcript selector.\n"
    prompt += "Perform language model rescoring based on the top-5 outputs generated by an Automatic Speech Recognition (ASR) system given a conversational history.\n"
    prompt += "Select the most accurate ASR transcription.\n<|eot_id|>\n"
