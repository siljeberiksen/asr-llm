...
def choose_best_sentence(context, choices):
    ...
    prompt += "Perform language model rescoring based on the top-5 outputs generated by an Automatic Speech Recognition (ASR) system given a converstional history\n"
    prompt += "Select the most accurate ASR transcription\n"
    prompt +=f"Context - conversational history:  [{', '.join(context)}]\n\n"
