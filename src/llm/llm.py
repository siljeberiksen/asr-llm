...
def choose_best_sentence(context, choices, port=8081):
    ...
    #      "{\n"
    #     '  "transcription": "The selected top-1 ASR transcription"\n'
    #     "}\n"
    #     "Do NOT include your reasoning.\n
    # )


    ### Your goal is to select the most accurate ASR transcription by following these reasoning steps:

    # 1. **Assess Contextual Coherence**  
    # - Compare each hypothesis against the given conversation history.  
    # - Does the hypothesis logically fit with the previous dialogue and maintain natural conversational flow?  

    # 2. **Evaluate Grammar & Fluency**  
    # - Identify grammatical errors or unnatural phrasing.  
    # - Prefer transcriptions that are well-formed and fluent.   

    # 3. **Select the Best Hypothesis**  
    # - Rank hypotheses based on the above criteria.  
    # - Output only the integer index `N` that corresponds to the most accurate hypothesis.  
