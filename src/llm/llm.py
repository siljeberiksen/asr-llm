...
#TODO use the schema
    ...
    response: ChatResponse = chat(
        ...
        messages=[
            # {"role": "system", "content": system_prompt},
            {"role": "system", "content": "You are an ASR transcript selector. Your task is to perform language model rescoring based on the top-5 outputs generated by an Automatic Speech Recognition (ASR) system, given a conversational history. Analyze the provided context and ASR hypotheses to select the most accurate transcription. Output the selected top-1 transcription in format <optionX> The selected top1 ASR transcription </optionX>."},
