...
tracker = EmissionsTracker(project_name="experiment_11")
...
try:
        ...
        run_experiment('../result/npsc_samtale_experiment_11_llm.json', '../result/beam_npsc_experiment_11_llm.json',"../result/wer_npsc_experiment_11_llm.json", whisper_model, 100, tracker, count)
