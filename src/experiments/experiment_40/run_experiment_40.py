...
tracker = EmissionsTracker(project_name="experiment_40")
...
try:
        ...
        run_experiment('../result/npsc_samtale_experiment_40_llm.json', '../result/beam_npsc_experiment_40_llm.json',"../result/wer_npsc_experiment_40_llm.json", whisper_model, 100, tracker, count)
    ...
    os.execv(sys.executable, [sys.executable, "-m", "experiments.experiment_40.run_experiment_40"])
