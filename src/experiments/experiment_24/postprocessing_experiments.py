...
post_process("wer_npsc_experiment_24_llm.json")

print("\n\n\nWithout empty instances")
empty_instances = find_empty_instances("beam_npsc_experiment_24_llm.json")
#post_process("wer_npsc_experiment_3.json", empty_instances)
post_process("wer_npsc_experiment_24_llm.json", empty_instances)

print("\nEmissions")
runEmissionPostProcessing("experiment_24", "emissions_24.csv")