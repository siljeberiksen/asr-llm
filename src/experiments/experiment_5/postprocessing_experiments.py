...
post_process("wer_npsc_experiment_5_llm.json")

print("\nnWithout empty instances")
empty_instances = find_empty_instances("beam_npsc_experiment_5_llm.json")
post_process("wer_npsc_experiment_5_llm.json", empty_instances)

print("\nEmissions")
runEmissionPostProcessing("experiment_5")
